...
public class HighScoresDialog extends Dialog {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        name1.setText((high_score_list.get(0)).getHighScoreName());
        score1.setText(( high_score_list.get(0)).getHighScoreValue());

        name2.setText((high_score_list.get(1)).getHighScoreName());
        score2.setText(( high_score_list.get(1)).getHighScoreValue());

        name3.setText(( high_score_list.get(2)).getHighScoreName());
        score3.setText((high_score_list.get(2)).getHighScoreValue());

        name4.setText((high_score_list.get(3)).getHighScoreName());
        score4.setText(( high_score_list.get(3)).getHighScoreValue());

        name5.setText((high_score_list.get(4)).getHighScoreName());
        score5.setText((high_score_list.get(4)).getHighScoreValue());

        name6.setText(( high_score_list.get(5)).getHighScoreName());
        score6.setText(( high_score_list.get(5)).getHighScoreValue());

        name7.setText((high_score_list.get(6)).getHighScoreName());
        score7.setText(( high_score_list.get(6)).getHighScoreValue());

        name8.setText((high_score_list.get(7)).getHighScoreName());
        score8.setText((high_score_list.get(7)).getHighScoreValue());

        name9.setText(( high_score_list.get(8)).getHighScoreName());
        score9.setText((high_score_list.get(8)).getHighScoreValue());

        name10.setText(( high_score_list.get(9)).getHighScoreName());
        score10.setText((high_score_list.get(9)).getHighScoreValue());
